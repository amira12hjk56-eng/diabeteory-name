...
if st.button("توقع النتيجة الآن"):
    ...
    # تحويل النتيجة من القاموس للعربي
    # لو الكلمة مش في القاموس هيطلع الكلمة الأصلية
    arabic_result = result_map.get(prediction, prediction)
    
    # إظهار النتيجة بشكل جميل
    st.info("تم تحليل البيانات بنجاح:")
